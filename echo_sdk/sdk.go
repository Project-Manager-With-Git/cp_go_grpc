...
type SDKConfig struct {
	...
	// 本地负载均衡
	Balance_With_Zookeeper bool `json:"balance_with_zookeeper,omitempty" jsonschema:"description=是否使用zookeeper做本地负载均衡"`
}
...
func (c *SDK) Init(conf *SDKConfig) error {
	...
	case 1:
		{
			if conf.Balance_With_Zookeeper {
...
func (c *SDK) initWithZooKeeperBalance() error {
	registry.RegisterResolver("zk", c.Address, "/backend/services", c.App_Name, c.App_Version)
	c.addr = "zk:///"
